...
HRESULT DemoApp::Initialize()
{
	...
	if (SUCCEEDED(hr))
	{
		...
		m_hwnd = CreateWindow(L"D2DDemoApp", L"Direct2D Demo Application", WS_OVERLAPPEDWINDOW,
...
// This method resize the render target appropriately
...
// Create a Direct2D bitmap from a resource in the resource file
	...
	ID2D1Bitmap **ppBitmap)
{
	...
	if (SUCCEEDED(hr))
	{
		// If a new width or height was specified, create an IWICBitmapScaler and use it to
		// resize the image
	...
	if (SUCCEEDED(hr))
	{
		// Create a Direct2D bitmap the wic bitmap
